...
async function main() {
    ...
    await open_position(ctx, whirlpool, quote, true);
}
...
ts-node 95b_deposit_into_mainnet_sol_usdc_with_metadata.ts 
...
tokenB max input 0.459507
liquidity 7309503
open_position signature 2QGwA8hV4s67ck3T5o8GxFf8pgHJZEETX19tqmqGdw5rv3WcWbBcr5s6vvLEySgrQUuNJU1iRtmycPy9Z2da5L5C
position NFT J3wwrG32Uv6XsAAMgJkE7fu2VnL1MUVoYnf6D4GqYLv9
