import * as idl from "../target/idl/cpi_whirlpool_open_position.json";
import type { CpiWhirlpoolOpenPosition } from "../target/types/cpi_whirlpool_open_position";
...
async function main() {
  ...
  const CPI_WHIRLPOOL_OPEN_POSITION_PROGRAM_ID = new anchor.web3.PublicKey("E9YsFZWX5ezohwgYjF31ATrKVVRzr594jDBiM4o84273");
  const wallet = anchor.AnchorProvider.env().wallet;
  const program = new Program(idl as anchor.Idl, CPI_WHIRLPOOL_OPEN_POSITION_PROGRAM_ID, anchor.getProvider()) as Program<CpiWhirlpoolOpenPosition>;
